  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center'>
        ...
        <div className='md:flex gap-5 pt-10 px-10'>
            <div className='basis-1/2 flex flex-col gap-5 md:text-2xl text-sm md:px-5'>
            ...
            <div className='basis-1/2 md:p-2 pt-10'>
              <img src={about} alt="flower" className='' />
            </div>
        </div>
        <div className='pt-10 px-10'>
            <p className='md:text-2xl text-sm'>Our major priority is to ensure every client gets value for money spent with an excellent customer service.</p>
        </div>
      </div>
      < Contact />
      < Footer />
